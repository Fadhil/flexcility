...
# Flexcility.Web.Endpoint.load_from_system_env/1 dynamically.
...
config :flexcility_web, Flexcility.Web.Endpoint,
  on_init: {Flexcility.Web.Endpoint, :load_from_system_env, []},
...
# start per endpoint:
#
#     config :flexcility_web, Flexcility.Web.Endpoint, server: true
#
